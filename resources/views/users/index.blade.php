<x-app-layout>
    ...
    @section('content')
        <div class="container mx-auto mt-5 flex flex-col space-y-4">
            ...
            <div class="container mx-auto mt-5 flex flex-col space-y-4 items-center">
                <h1 class="text-2xl font-bold mb-4">{{ __('messages.create_a_new_user') }}</h1>
                <a href="{{ route('users.create') }}" class="my-button">{{ __('messages.create_a_new_user') }}</a>
            </div>

            <br><br><br>
            
            <div class="flex flex-col space-y-2">
                <h1 class="text-2xl font-bold mb-2">{{ __('messages.super_admin_user') }}</h1>

                <div class="w-1/2 mb-4">
                    <input type="text" id="search_email_super_admin_users" placeholder="{{ __('messages.search_by_email') }}" class="border w-full p-2">
                </div>
                ...
                <table class="table-auto w-full border-collapse border border-gray-200">
                    <thead>
                        <tr class="bg-gray-100">
                            ...
                            <th scope="col" class="border border-gray-200 px-4 py-2">{{ __('messages.email') }}</th>
            ...
            <div class="flex flex-col space-y-2">
                <h1 class="text-2xl font-bold mb-2">{{ __('messages.admin_user') }}</h1>
                <div class="w-1/2 mb-4">
                    <input type="text" id="search_email_admin_users" placeholder="{{ __('messages.search_by_email') }}" class="border w-full p-2">
                </div>
                <table class="table-auto w-full border-collapse border border-gray-200">
                    <thead>
                        <tr class="bg-gray-100">
            ...
            <div class="flex flex-col space-y-2">
                <h1 class="text-2xl font-bold mb-2">{{ __('messages.guest_user') }}</h1>
                <div class="w-1/2 mb-4">
                    <input type="text" id="search_email_guest_users" placeholder="{{ __('messages.search_by_email') }}" class="border w-full p-2">
                </div>
                <table class="table-auto w-full border-collapse border border-gray-200">
                    <thead>
                        <tr class="bg-gray-100">
